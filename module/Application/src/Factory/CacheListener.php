...
class CacheListener extends AbstractListenerAggregate {
     ...
     * @param \Laminas\Cache\Storage\Adapter\Filesystem $cacheService
     */
    public function __construct(\Laminas\Cache\Storage\Adapter\Filesystem $cacheService) {
    // We store the cache service generated by Laminas\Cache from the service manager
     ...
     * @return void|\Laminas\Stdlib\ResponseInterface
     */
