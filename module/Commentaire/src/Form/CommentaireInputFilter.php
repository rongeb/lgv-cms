            ...
            'validators' => array(
                array(
                    ...
                    'options' => array(
                        'pattern' => '/^[-]?[0-9]*$/',
                        'messages' => array(
                            \Laminas\Validator\Regex::NOT_MATCH => 'La position doit être vide ou doit être un nombre',
                        ),
                    ),
                ),
        )));
        ...
        $this->add(array(
            ...
            'validators' => array(
                ...
                array(
                    ...
                    'options' => array(
                        'messages' => array(
                            \Laminas\Validator\NotEmpty::IS_EMPTY => $this->translator->translate('Vous devez choisir un contenu')
                        ),
                    ),
                ),
            ),
